    ...
    <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
      <Box sx={{ textAlign: "center", mb: 4 }}>
        ...
        <Stack direction="row" spacing={2} justifyContent="center" sx={{ mb: 2 }}>
          <Button component={Link} href="/movimientos" variant="contained" color="primary" size="large">
            Empezar ahora
          </Button>
          <Button component={Link} href="/reportes" variant="outlined" color="primary" size="large">
            Ver reportes
          </Button>
        </Stack>
      </Box>
      ...
      <Box sx={{ mt: 6 }}><AccionesARGYSection /></Box>
